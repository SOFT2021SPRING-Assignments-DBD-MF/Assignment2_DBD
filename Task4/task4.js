console.log("1. Map the list of numbers to a list of their square roots: [1, 9, 16, 100]");
console.log("---------------------------------------------------------------------------");
var array1 = [1, 9, 16, 100];
var newArray1 = array1.map(x => Math.sqrt(x));
console.log(newArray1);
console.log("*****************************************************************************");
console.log("2. Map the list of words so each is wrapped in a <h1> tag: [“Intro”, “Requirements”, “Analysis”, “Implementation”, “Conclusion”, “Discussion”, “References”]");
console.log("------------------------------------------------------------------------------------------------------------------------------------------------------------");
var array2 = ["Intro", "Requirements", "Analysis", "Implementation", "Conclusion", "Discussion", "References"];
var newArray2 = array2.map(x => "<h1>" + x + "</h1>");
console.log(newArray2);
console.log("*****************************************************************************");
console.log("3. Use map to uppercase the words (all letters): [“i’m”, “yelling”, “today”]");
console.log("----------------------------------------------------------------------------");
var array3 = ["i’m", "yelling", "today"];
var newArray3 = array3.map(x => x.toUpperCase());
console.log(newArray3);
console.log("*****************************************************************************");
console.log("4. Use map to transform words into their lengths: [“I”, “have”, “looooooong”, “words”]");
console.log("--------------------------------------------------------------------------------------");
var array4 = ["I", "have", "looooooong", "words"];
var newArray4 = array4.map(x => x.length);
console.log(newArray4);
console.log("*****************************************************************************");
console.log("5. Get the json file comics.json from the course site. Paste it into your browser’s Javascript console. Use map to get all the image urls, and wrap them in img-tags.");
console.log("---------------------------------------------------------------------------------------------------------------------------------------------------------------------");
var array5 = comics = [
    {
      "month": "1",
...
var newArray5 = array5.map(x => "<img>" + x.img + "</img>");
console.log(newArray5);
console.log("*****************************************************************************");
console.log("6. Use reduce to sum the array of numbers: [1,2,3,4,5]");
console.log("------------------------------------------------------");
var array6 = [1,2,3,4,5];
var newArray6 = array6.reduce((accumulator, value) => accumulator + value);
console.log(newArray6);
console.log("*****************************************************************************");
console.log("7. Use reduce to sum the x-value of the objects in the array: [{x: 1},{x:2},{x: 3}]");
console.log("-----------------------------------------------------------------------------------");
var array7 = [{x:1},{x:2},{x:3}];
var newArray7 = array7.reduce((accumulator, value) => accumulator + value.x,0);
console.log(newArray7);
console.log("*****************************************************************************");
console.log("8. Use reduce to flatten an array of arrays: [[1,2],[3,4],[5,6]]");
console.log("----------------------------------------------------------------");
var array8 = [[1,2],[3,4],[5,6]];
var newArray8 = array8.reduce((accumulator, value) => accumulator.concat(value),[]);
console.log(newArray8);
console.log("*****************************************************************************");
console.log("9. Use reduce to return an array of the positive numbers: [-3, -1, 2, 4, 5]");
console.log("---------------------------------------------------------------------------");
//Source link: https://zetcode.com/javascript/reduce/
var array9 = [-3, -1, 2, 4, 5];
var newArray9 = array9.reduce((accumulator, value) => {
       if(value > 0){
